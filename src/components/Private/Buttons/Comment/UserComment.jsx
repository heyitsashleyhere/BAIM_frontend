...
export const UserComment = ({ post } ) => {
  ...
  useEffect(() => {
    ...
    fetch(`https://cors-anywhere-baim.herokuapp.com/https://loka-database.herokuapp.com/comments/${post._id}`, config)
  ...
  function editComment() {
    ...
    fetch(`https://cors-anywhere-baim.herokuapp.com/https://loka-database.herokuapp.com/comments/${commentData._id}`, config)
      .then((response) => response.json())
      .then((result) => {
