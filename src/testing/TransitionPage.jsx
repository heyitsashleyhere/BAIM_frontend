...
const TransitionPage = () => {
  ...
  useEffect(() => {
    ...
    tl.set(overlayPathIn.current, {
      ...
      .from([textRef.current, textRef2.current], {
        duration: 0.8,
        y: '100%',
        opacity: 0,
        stagger: 0.2,
        ease: Quint.easeOut,
        onComplete: function () { setIsOverlay(true) }
      }, '-=1');
  ...
  <>
    { isOverlay && (
      ...
      <svg className="overlay" width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none">
            <path ref={overlayPathIn} className="transition-page-layer-one" vectorEffect="non-scaling-stroke" d="M 0 100 V 100 Q 50 100 100 100 V 100 z"
            fill='white'      />
		</svg>
      ...
      <svg className="overlay2" width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none" >
        <defs>
        <pattern id="img1" patternUnits="userSpaceOnUse" width="100" height="100">
            <image href={Logo} x="0" y="0" width="100" height="100"  />
          </pattern>
          </defs>
            <path ref={overlayPathOut} className="transition-page-layer-two" vectorEffect="non-scaling-stroke" d="M 0 100 V 100 Q 50 100 100 100 V 100 z"
            fill='white'
        />
		</svg>
        </section>
